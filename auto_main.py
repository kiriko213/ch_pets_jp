    ...
    try:
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            if not initial_topic:
                ...
                prompt = f"""猫に関する、まだ誰も見たことがないような新しいサブトピックを日本語で1件だけ出力してください。
前置きや解説、マークダウン記号などは一切含めず、サブトピック名のみを出力してください。

【ジャンル選択ルール】
『体の仕組み（身体能力、感覚、反射など）』に偏る「仕組みループ」を絶対に避けてください。
代わりに、以下のいずれかのカテゴリーから、これまでにない全く新しい切り口のトピックを選択してください：
- 【歴史】古代エジプトでの扱い、歴史上の偉人と猫、神話や民話
- 【心理】猫の本当の気持ち、感情表現、特定の行動に隠された深層心理
- 【行動】奇妙な癖、他の動物や人間に対する反応、集団行動の謎
- 【人間との関係】猫が人間に与える影響、共生の歴史、猫にまつわる文化や慣習
- 【雑学・ギネス】世界一の記録、名前の由来、意外な生態のトリビア
